...
export function createMachineWorksRailFoundationRecipe(): RecipeV1 {
  ...
  return defineMachineRecipe({
    ...
    steps: [
      purposefulPartStep('open-frame', [0, 0, 0], {
        width: 31,
        height: 4,
        depth: 11,
        thickness: 1,
        role: 'structure',
      }, 'Builds the long open support frame', purpose(
        'rail-foundation:open-support-frame',
        'Removing it leaves every cross-tie, guard, bridge pad, and drive datum without one continuous grounded frame.',
        'supports', 'the complete conveyor and press support chain',
        'Its four continuous perimeter members terminate on the ground plane and face-connect every repeated cross-tie.',
      )),
      ...tieStations.map((x) =>
      ...
      machineBoxStep([8, 4, 6], [5, 1, 2], 'structure', 'Spreads the west tower front foot into the conveyor foundation', purpose('rail-foundation:west-front-bridge-pad', 'Removing it leaves the west-front bridge foot without an occupied positive-area foundation landing.', 'supports', 'the west-front press-bridge foot', 'Its top face coincides with the named west-front bridge-foot port and its bottom joins the underframe.')),
      machineBoxStep([8, 4, 9], [5, 1, 2], 'structure', 'Spreads the west tower rear foot into the conveyor foundation', purpose('rail-foundation:west-rear-bridge-pad', 'Removing it leaves the west-rear bridge foot without an occupied positive-area foundation landing.', 'supports', 'the west-rear press-bridge foot', 'Its top face coincides with the named west-rear bridge-foot port and its bottom joins the underframe.')),
      machineBoxStep([21, 4, 6], [5, 1, 2], 'structure', 'Spreads the east tower front foot into the conveyor foundation', purpose('rail-foundation:east-front-bridge-pad', 'Removing it leaves the east-front bridge foot without an occupied positive-area foundation landing.', 'supports', 'the east-front press-bridge foot', 'Its top face coincides with the named east-front bridge-foot port and its bottom joins the underframe.')),
      machineBoxStep([21, 4, 9], [5, 1, 2], 'structure', 'Spreads the east tower rear foot into the conveyor foundation', purpose('rail-foundation:east-rear-bridge-pad', 'Removing it leaves the east-rear bridge foot without an occupied positive-area foundation landing.', 'supports', 'the east-rear press-bridge foot', 'Its top face coincides with the named east-rear bridge-foot port and its bottom joins the underframe.')),
    ],
  });
}
...
export function createMachineWorksPressBridgeRecipe(): RecipeV1 {
  return defineMachineRecipe({
    ...
    seed: 7_109,
    size: [25, 20, 6],
    summary: 'Four foundation feet carry two rectilinear towers, while fixed linear-stator spines descend from the load beam through empty moving C-yoke cavities.',
    ...
    steps: [
      ...
      purposefulPartStep('open-frame', [20, 0, 0], {
        width: 5,
        height: 15,
        depth: 6,
        thickness: 1,
      ...
      machineBoxStep([7, 0, 0], [1, 15, 1], 'wear', 'Provides the core head inner visual alignment face', purpose('press-bridge:core-alignment-face', 'Removing it leaves the core-head rear pad with no straight visual datum for its prescribed stroke.', 'aligns', 'the core-head rear alignment pad', 'The named pad remains tangent to this exact straight face throughout the swept pose without claiming constraint.')),
      machineBoxStep([17, 0, 0], [1, 15, 1], 'wear', 'Provides the cap head inner visual alignment face', purpose('press-bridge:cap-alignment-face', 'Removing it leaves the cap-head rear pad with no straight visual datum for its prescribed stroke.', 'aligns', 'the cap-head rear alignment pad', 'The named pad remains tangent to this exact straight face throughout the swept pose without claiming constraint.')),
      machineBoxStep([5, 0, 0], [1, 15, 1], 'detail', 'Passes the cream core fixed-stator spine through the orange moving C-yoke cavity with visible running clearance', purpose('press-bridge:core-fixed-stator', 'Removing it leaves the core C-yoke and vertical command without a visible fixed actuator datum.', 'engages', 'the core moving C-yoke', 'The exact stator remains inside the empty three-sided yoke cavity with hashed transverse clearance and no contact claim.')),
      machineBoxStep([19, 0, 0], [1, 15, 1], 'detail', 'Passes the cream cap fixed-stator spine through the orange moving C-yoke cavity with visible running clearance', purpose('press-bridge:cap-fixed-stator', 'Removing it leaves the cap C-yoke and vertical command without a visible fixed actuator datum.', 'engages', 'the cap moving C-yoke', 'The exact stator remains inside the empty three-sided yoke cavity with hashed transverse clearance and no contact claim.')),
...
function driveDrumEndSteps(
  ...
  return [
    machineBoxStep([4, 0, z], [3, 1, 3], 'safety', `Marks the ${end} lower rotating boundary`, purpose(
    ...
    machineBoxStep([2, 1, z], [7, 1, 3], 'structure', `Forms the ${end} lower retaining-flange tier`, purpose(
    ...
    machineBoxStep([1, 2, z], [9, 2, 3], 'structure', `Carries the ${end} lower end-cheek load into the hub band`, purpose(
    ...
    machineBoxStep([0, 4, z], [1, 3, 3], 'safety', `Marks the ${end} left rotating boundary`, purpose(
    ...
    machineBoxStep([1, 4, z], [9, 3, 3], 'structure', `Spans the ${end} central end-cheek hub band`, purpose(
    ...
    machineBoxStep([10, 4, z], [1, 3, 3], 'safety', `Marks the ${end} right rotating boundary`, purpose(
    ...
    machineBoxStep([1, 7, z], [9, 2, 3], 'structure', `Carries the ${end} upper end-cheek load into the hub band`, purpose(
    ...
    machineBoxStep([2, 9, z], [7, 1, 3], 'structure', `Forms the ${end} upper retaining-flange tier`, purpose(
    ...
    machineBoxStep([4, 10, z], [3, 1, 3], 'safety', `Marks the ${end} upper rotating boundary`, purpose(
...
export function createMachineWorksDriveDrumRecipe(): RecipeV1 {
  return defineMachineRecipe({
    ...
    steps: [
      ...
      machineBoxStep([2, 2, 3], [7, 7, 13], 'wear', 'Joins both retaining end cheeks with a central pitch barrel that does not claim belt contact', purpose(
        ...
        'Its near and far faces contact the end-cheek slabs at z=2 and z=16 while the authored slat path retains clearance from this barrel.',
      )),
      ...
      machineBoxStep([5, 1, 18], [1, 4, 1], 'detail', 'Indicates the far drum angle with one asymmetric phase stripe', purpose(
...
export function createMachineWorksExposedDriveCogRecipe(): RecipeV1 {
  return defineMachineRecipe({
    ...
    steps: [
      machineBoxStep([4, 4, 0], [3, 3, 3], 'structure', 'Centers the phase witness on the visible drum axle', purpose(
        'drive-cog:axle-hub',
        ...
        'The centered three-cube hub occupies the axle datum and shares a full three-by-three face with the flag root at y=4.',
      )),
      machineBoxStep([4, 1, 0], [3, 3, 3], 'safety', 'Indicates the drum angle with one unambiguous radial flag', purpose(
...
export function createMachineWorksCollectionBucketRecipe(): RecipeV1 {
  return defineMachineRecipe({
    ...
    roles: ['empty', 'structure', 'wear', 'safety'],
    steps: [
      machineBoxStep([2, 0, 2], [11, 1, 9], 'wear', 'Lays the replaceable bucket floor', purpose(
      ...
      machineBoxStep([1, 0, 11], [13, 1, 2], 'safety', 'Extends the grounded rear heel behind the receiving floor', purpose(
      ...
      machineBoxStep([2, 1, 10], [11, 8, 1], 'structure', 'Raises the rear containment wall', purpose(
      ...
      machineBoxStep([2, 1, 2], [1, 8, 8], 'structure', 'Raises the left containment wall', purpose(
      ...
      machineBoxStep([12, 1, 2], [1, 8, 8], 'structure', 'Raises the right containment wall', purpose(
      ...
      machineBoxStep([3, 1, 2], [9, 3, 1], 'structure', 'Forms the low front receiving lip', purpose(
      ...
      machineBoxStep([1, 3, 0], [13, 1, 2], 'safety', 'Extends the front mouth datum below the low lip', purpose(
      ...
      machineBoxStep([1, 9, 10], [13, 1, 2], 'safety', 'Bounds the rear wall top edge with a collision rim', purpose(
      ...
      machineBoxStep([1, 9, 2], [2, 1, 8], 'safety', 'Bounds the left wall top edge with a collision rim', purpose(
      ...
      machineBoxStep([12, 9, 2], [2, 1, 8], 'safety', 'Bounds the right wall top edge with a collision rim', purpose(
...
export function createMachineWorksOutputDockRecipe(): RecipeV1 {
  return defineMachineRecipe({
    ...
    roles: ['empty', 'structure', 'wear', 'safety', 'detail'],
    steps: [
      machineBoxStep([1, 0, 3], [6, 1, 3], 'wear', 'Combines the near foundation shoe and lower bearing bed outside the moving belt', purpose(
      ...
      machineBoxStep([6, 1, 4], [1, 5, 2], 'wear', 'Carries the near C-housing behind the full axle swept envelope', purpose(
      ...
      machineBoxStep([2, 5, 4], [4, 1, 2], 'wear', 'Closes the near C-housing above the axle with declared running clearance', purpose(
      ...
      machineBoxStep([1, 0, 25], [6, 1, 3], 'wear', 'Combines the far foundation shoe and lower bearing bed outside the moving belt', purpose(
      ...
      machineBoxStep([6, 1, 25], [1, 5, 2], 'wear', 'Carries the far C-housing behind the same swept envelope', purpose(
      ...
      machineBoxStep([2, 5, 25], [4, 1, 2], 'wear', 'Closes the far C-housing above the axle with declared running clearance', purpose(
      ...
      machineBoxStep([4, 2, 27], [1, 2, 1], 'safety', 'Couples the trunnion end face to the visible rotary-servo output', purpose(
        ...
        'The one-voxel axial coupler is coaxial with both bearing bores and face-contacts the trunnion at z=27 and servo housing at z=28.',
      )),
      machineBoxStep([2, 0, 28], [5, 1, 2], 'structure', 'Supports the servo housing on the occupied far foundation pad', purpose(
      ...
      machineBoxStep([2, 1, 28], [5, 5, 2], 'structure', 'Houses the outboard rotary position servo immediately behind its output coupler', purpose(
        ...
        'The fixed housing is coaxial with the coupler and both bearing bores; the consumer prescribes position without claiming simulated torque.',
      )),
      machineBoxStep([3, 2, 30], [3, 3, 1], 'safety', 'Marks the outboard servo axis on the exterior end cap', purpose(
        ...
        'The centered three-by-three cap is normal to and centered on the same z-axis as the trunnion, coupler, and fixed housing.',
      )),
      machineBoxStep([0, 0, 28], [2, 1, 2], 'detail', 'Anchors the external service entry beside the far bearing shoe', purpose(
      ...
      machineBoxStep([0, 1, 28], [1, 3, 2], 'detail', 'Raises the servo-service conduit outside the bearing load path', purpose(
      ...
      machineBoxStep([0, 4, 28], [2, 1, 2], 'detail', 'Connects the external service conduit to the servo housing input face', purpose(
...
export function createMachineWorksInsertionHeadRecipe(): RecipeV1 {
  return defineMachineRecipe({
    ...
    steps: [
      machineBoxStep([3, 0, 7], [7, 1, 7], 'detail', 'Forms the flat electromagnetic pickup face that holds a preloaded ferromagnetic datum', purpose(
      ...
      machineBoxStep([3, 1, 7], [7, 3, 7], 'structure', 'Backs the pickup face so magnetic holding load reaches the ram', purpose(
      ...
      machineBoxStep([4, 4, 7], [5, 3, 2], 'detail', 'Represents the pre-frame-zero charge buffer for the electromagnetic pickup', purpose(
      ...
      machineBoxStep([5, 4, 9], [3, 14, 3], 'wear', 'Carries insertion load from the moving slide to the pickup plate', purpose(
      ...
      machineBoxStep([6, 4, 9], [1, 14, 1], 'detail', 'Routes the local buffer service through the ram to the magnetic pickup', purpose(
      ...
      machineBoxStep([2, 7, 7], [3, 5, 7], 'structure', 'Builds the west load-bearing half of the moving slide', purpose(
      ...
      machineBoxStep([8, 7, 7], [3, 5, 7], 'structure', 'Builds the east load-bearing half of the moving slide', purpose(
      ...
      machineBoxStep([5, 7, 7], [3, 2, 2], 'structure', 'Closes the lower front slide bridge', purpose(
      ...
      machineBoxStep([5, 7, 12], [3, 2, 2], 'structure', 'Closes the lower rear slide bridge', purpose(
      ...
      machineBoxStep([5, 10, 7], [3, 2, 2], 'structure', 'Closes the upper front slide bridge', purpose(
      ...
      machineBoxStep([5, 10, 12], [3, 2, 2], 'structure', 'Closes the upper rear slide bridge', purpose(
      ...
      machineBoxStep([1, 8, 13], [11, 2, 2], 'structure', 'Ties both slide halves to the rear alignment datums and open actuator yoke', purpose(
        ...
        'The eleven-wide tie face-connects both slide halves at z=13, both datum pads at z=15, and both yoke cheeks.',
      )),
      machineBoxStep([1, 8, 15], [1, 2, 1], 'wear', 'Exposes the west rear visual alignment datum without claiming captive constraint', purpose(
      ...
      machineBoxStep([11, 8, 15], [1, 2, 1], 'wear', 'Exposes the east rear visual alignment datum without claiming captive constraint', purpose(
      ...
      machineBoxStep([2, 8, 15], [1, 2, 6], 'safety', 'Marks the moving west yoke cheek and its pinch boundary outside the stator running clearance', purpose(
      ...
      machineBoxStep([10, 8, 15], [1, 2, 6], 'safety', 'Marks the moving east yoke cheek and its pinch boundary outside the stator running clearance', purpose(
      ...
      machineBoxStep([3, 8, 20], [7, 2, 1], 'safety', 'Marks the moving rear C-yoke bridge while preserving stator running clearance', purpose(
  ...
  return defineMachineRecipe({
    ...
    steps: [
      machineBoxStep([2, 0, 2], [3, 2, 3], 'wear', 'Shapes the keyed lower stem', purpose(
        ...
        'The exact three-by-three stem occupies the socket two layers deep with one voxel of lateral assembly clearance.',
      )),
