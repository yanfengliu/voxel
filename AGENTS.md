...
- Keep `README.md` capability-oriented: do not add Studio scene descriptions, inventories, status, provenance, metrics, or per-scene links there. Scenes belong as versioned stable-ID records in the content catalog/database alongside parts, recipes, and models; keep all scene content in those records or focused Studio, design, and test surfaces.
