...
- Creative assets: before generating, curating, promoting, or integrating procedural parts, recipes, models, motion, or scenes here or for a downstream game, use `create-diverse-voxel-assets`; its canonical skill is `docs/skills/create-diverse-voxel-assets/SKILL.md`. A contact sheet proves comparison, not scene coherence.
...
- Keep `README.md` capability-oriented: never inventory, narrate, or track individual Studio scenes there. Scenes belong as versioned stable-ID records in the content catalog/database alongside parts, recipes, and models; keep scene descriptions, sidecar and replay provenance, and evidence in those records or focused Studio, design, and test surfaces.
