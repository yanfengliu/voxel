...
export const OAK_PURPOSE_ACCOUNTABILITY_V1 = Object.freeze([
  ...
  record(
    'inspection-views',
    'Hero, side and overhead camera presets plus the root-cutaway presentation mode.',
    'Whole-organism framing, adversarial silhouette inspection and belowground support inspection.',
    'Expose the organism from complementary elevations and reveal the hidden root support on command.',
    'All presets fit accepted public-geometry vertices; cutaway keeps the declared side of its soil plane.',
    'Removing side/overhead hides edge-on leaves and crown overlap; removing cutaway hides fine roots inside soil.',
    'Moving focus away from the fitted envelope clips the subject or lets the HUD obscure it.',
    'Three orthogonal-biased views plus one cutaway are the smallest retained sweep that exposes the observed risks.',
    ['oak-ecosystem.spec.ts/fixed cameras, root cutaway, resize, capture, and teardown stay coherent'],
    'These fixed views support inspection; they do not prove every possible camera or mature-tree envelope.',
