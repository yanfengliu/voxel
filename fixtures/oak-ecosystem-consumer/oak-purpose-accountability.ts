...
export const OAK_PURPOSE_ACCOUNTABILITY_V1 = Object.freeze([
  ...
  record(
    'hud-and-diagnostics',
    'The single HUD panel, three view selectors, status line and 20 live diagnostic rows.',
    ...
    'One compact panel and 20 non-duplicated values are the minimum retained interface for biological, weather, soil and runtime evidence.',
