...
export const OAK_PARAMETER_PROVENANCE_V1 = Object.freeze([
  ...
  {
    id: 'oak-leaf-expansion-window',
    class: 'species-observation',
    title: 'Environmental conditions and vascular cambium regulate carbon allocation to xylem growth in deciduous oaks',
    sourceUrl: 'https://doi.org/10.1111/1365-2435.12789',
    scope: 'Q. robur leaf expansion lasted 26–40 days in the reported mature trees; the fixture 28-day plan remains a bounded hypothesis, not seedling calibration.',
  },
  {
    id: 'oak-growth-phase-order',
    class: 'species-observation',
    title: 'Endogenous rhythmic growth in oak trees is regulated by internal clocks rather than resource availability',
    sourceUrl: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC4765786/',
    scope: 'Supports only bud rest, swelling, shoot elongation and leaf expansion ordering; exact fixture timing is not source-derived.',
  },
  {
    id: 'leaf-cell-development-pattern',
    ...
    sourceUrl: 'https://doi.org/10.1093/jxb/eru358',
    scope: 'Supports only separating and overlapping division and expansion cohorts; it is not Quercus calibration.',
  },
  {
  ...
  },
  {
    id: 'oak-leaf-form',
    class: 'species-observation',
    title: 'Quercus robur L. general information',
    sourceUrl: 'https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:304293-2/general-information',
    scope: 'Kew describes four or five rounded lobes on each side and almost no leaf stalk; numeric station widths, display camber, secondary-vein colour, voxel thickness and petiole section remain fixture assumptions.',
  },
  {
...
export const OAK_PARAMETERS_V1 = Object.freeze({
  ...
  physiology: {
    ...
    postPrimaryMobileCarbonReserveKg: 0.00045,
    daylightStartHour: 6,
    daylightEndHour: 18,
  ...
  roots: {
    ...
    nitrogenStressReferenceKg: 0.00006,
  ...
  growth: {
    ...
    development: {
      primordiumFraction: 0.005,
      minimumDimensionedWoodLengthM: 0.0005,
      lateralNodeExposureLengthM: 0.002,
      distalNodeExposureLengthM: 0.004,
      lateralNodeClearanceRadiusMultiple: 1.5,
      distalNodeClearanceRadiusMultiple: 2.5,
      maximumDevelopmentFractionPerAllocation: 0.0025,
      divisionCarbonFraction: 0.2,
      expansionCarbonFraction: 0.85,
      emergenceDivisionDays: 2,
      emergenceExpansionDays: 5,
      emergenceCompletionDays: 6,
      budSwellingDurationDays: 4,
      budSwellingMassScale: 1.12,
      flushAxisDivisionDays: 4,
      flushAxisExpansionDays: 18,
      flushAxisMaturationDays: 24,
      flushLeafDivisionDelayDays: 2,
      flushLeafDivisionDays: 6,
      flushLeafExpansionDays: 20,
      flushLeafMaturationDays: 24,
      terminalBudDivisionDelayDays: 16,
      terminalBudDivisionDays: 19,
      terminalBudExpansionDays: 22,
      terminalBudMaturationDays: 24,
      leafFallDurationDays: 1.5,
      leafFallContactHeightM: 0.001,
      abscissionSeparationM: 0.000_001,
      leafFallWindDriftMPerMPerS: 0.0006,
      leafFallStaggerDaysPerSlot: 0.8,
      /** Maximum distance from the leaf base to the recolored parent surface cell. */
      abscissionWoundSearchRadiusM: 0.006,
    },
    radicleDay: 3,
    shootDay: 6,
    flushDays: [12, 42, 82],
    ...
    senescentNitrogenResorptionFraction: 0.5,
    senescentPhosphorusResorptionFraction: 0.52,
    ...
    mechanismProvenanceIds: Object.freeze([
      ...
      provenanceId('oak-leaf-expansion-window'),
      provenanceId('oak-growth-phase-order'),
      provenanceId('leaf-cell-development-pattern'),
    ]),
    parameterProvenanceId: provenanceId('early-slice-calibration'),
  },
  leafGeometry: {
    ...
    variants: [
      {
        id: 'broad-nine-lobe' as const,
        stationWidths: [0.055, 0.15, 0.24, 0.18, 0.34, 0.26, 0.39, 0.27, 0.32, 0.17, 0.1],
        camber: 0.055,
        lobeCount: 9,
    ...
    formProvenanceId: provenanceId('oak-leaf-form'),
    parameterProvenanceId: provenanceId('early-slice-calibration'),
  },
  mechanics: {
    ...
    // This bounded first-year slice tapers across successive extension units;
    // each short internode itself stays cylindrical so its distal section can
    // carry the already-authored continuation without an unmodelled node shell.
    woodTipRadiusRatio: 1,
