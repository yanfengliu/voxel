...
A sealed [named-hardware measurement](../../benchmarks/results/2026-07-26T05-12-53-840Z-clustered-lights-1000.json) of commit `1f4377d` replayed five identical 600-frame sequences at 1280×720 DPR 1 in headless Chromium 147 on an RTX 4090. It measured 1,201.2 GPU-synchronized uncapped Studio draws/s, 0.80/0.90/1.10 ms frame p50/p95/p99, and an 826.4 draws/s slowest-1%-mean rate; every frame kept all 1,000 moving lights visible, maximum cluster occupancy was 13 of 32, program creation remained at five through the 1,000→999→1,000 probe, and the 35 receiver placements plus the light-marker batch drew as 2 calls and 41,680 triangles. This is a CPU cluster-rebuild, texture/instance-upload, and small-receiver microbenchmark—not display FPS, gameplay FPS, or a game-sized-scene result.
