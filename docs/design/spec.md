...
The private Model Studio now includes 30 manually curated recipes across six contrast families and four neutral domains, supported by seven reusable shape-changing parts and four domain scenes. Every recipe appears once across those scenes, and four semantically animated models in the mechanical-industrial, civic-architectural, and natural-organic scenes exercise the persisted scene-animation control independently of the lighting proof.
