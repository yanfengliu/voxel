...
The earlier sealed [named-hardware measurement](../../benchmarks/results/2026-07-26T05-12-53-840Z-clustered-lights-1000.json) of commit `1f4377d` replayed the predecessor 35-receiver workload. Its 1,201.2 GPU-synchronized uncapped Studio draws/s and 41,680-triangle result remain source-sealed historical evidence, not a measurement of the current 1,000-receiver proof, display FPS, gameplay FPS, or a game-sized scene.
