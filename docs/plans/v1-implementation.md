...
- [x] V-07 bounded deterministic scheduler, group leases, coalescing/cancellation, one-crash retry, a timer-free unproven-generation startup circuit with one half-open probe, three eligibility firewalls, lifecycle accounting, and focused tests.
