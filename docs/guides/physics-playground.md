...
What is **not** modelled, and is not claimed: rolling resistance exists only where a body declares it and is applied on any contact rather than only a rolling one, joints have no friction, there is no air resistance of any kind, and no material deforms or fractures. The rotational term in the energy accounting is included because it is physically part of the total, not because any test needs it — zeroing it flips no verdict here; measured, it lowers the noise floor from 0.50% to 0.43%.
