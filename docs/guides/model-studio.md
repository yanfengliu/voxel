...
The earlier sealed [named-hardware run](../../benchmarks/results/2026-07-26T05-12-53-840Z-clustered-lights-1000.json) measured the predecessor 35-receiver scene at commit `1f4377d`. Its 1,201.2 GPU-synchronized uncapped Studio draws/s and 41,680-triangle workload remain reproducible evidence for that historical source tree, not the current 1,000-receiver workload, requestAnimationFrame/display FPS, gameplay FPS, or a full game-sized scene.
